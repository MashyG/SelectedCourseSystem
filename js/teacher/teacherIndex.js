...
function manageStudent(){
    $('div.all_info').load("studentList.html");
    getAllStudent();
}
function checkCourse(){
    $('div.all_info').load("courseMessage.html");
}
function checkSelectCourse(){
    $('div.all_info').load("selectCourse.html");
}
...
function add(){
    window.open("/../../pages/teacher/addStudent.html");
}
        ...
        success: function (data) {
            ...
            $.each(data.result, function (i, n) {
                ...
                tbBody += "<tr><td>" + n.stuId + "</td>" + "<td>" + n.stuName + "</td>" + "<td>" + n.sex + "</td>"
                    + "<td>" + n.graName + "</td>" + "<td>" + n.acaName + "</td>" + "<td>" + n.proName + "</td>" +
                    "<td>" + n.claName + "</td>" + "<td>" + n.phone + "</td>" + "<td>" + n.createDate + "</td><td>" +
                    "<a target='_parent' onclick='editStudent(" + n.stuId + ")'>修改</a></td></tr>";
                $(".tbBody").append(tbBody);
            });
        },
        error: function (jqXHR) {
